CREATE TABLE public.customer (c_id numeric(5,0) , c_d_id numeric(2,0) , c_w_id numeric(4,0) , c_first character varying(16), c_middle character(2), c_last character varying(16), c_street_1 character varying(20), c_street_2 character varying(20), c_city character varying(20), c_state character(2), c_zip character(9), c_phone character(16), c_since timestamp without time zone, c_credit character(2), c_credit_lim numeric(12,2), c_discount numeric(4,4), c_balance numeric(12,2), c_ytd_payment numeric(12,2), c_payment_cnt numeric(8,0), c_delivery_cnt numeric(8,0), c_data character varying(500)) WITH (fillfactor='50');

CREATE TABLE public.district (d_id numeric(2,0) , d_w_id numeric(4,0) , d_ytd numeric(12,2), d_tax numeric(4,4), d_next_o_id numeric, d_name character varying(10), d_street_1 character varying(20), d_street_2 character varying(20), d_city character varying(20), d_state character(2), d_zip character(9)) WITH (fillfactor='10');
...
CREATE TABLE public.warehouse (w_id numeric(4,0) , w_ytd numeric(12,2), w_tax numeric(4,4), w_name character varying(10), w_street_1 character varying(20), w_street_2 character varying(20), w_city character varying(20), w_state character(2), w_zip character(9)) WITH (fillfactor='10')  ;      
CREATE TABLE public.stock (s_i_id numeric(6,0) , s_w_id numeric(4,0) , s_quantity numeric(6,0), s_dist_01 character(24), s_dist_02 character(24), s_dist_03 character(24), s_dist_04 character(24), s_dist_05 character(24), s_dist_06 character(24), s_dist_07 character(24), s_dist_08 character(24), s_dist_09 character(24), s_dist_10 character(24), s_ytd numeric(10,0), s_order_cnt numeric(6,0), s_remote_cnt numeric(6,0), s_data character varying(50)) WITH (fillfactor='50');         
CREATE TABLE public.new_order (no_w_id numeric , no_d_id numeric , no_o_id numeric ) WITH (fillfactor='50');        
CREATE TABLE public.orders (o_id numeric , o_w_id numeric , o_d_id numeric , o_c_id numeric, o_carrier_id numeric, o_ol_cnt numeric, o_all_local numeric, o_entry_d timestamp without time zone) WITH (fillfactor='50');         
CREATE TABLE public.order_line (ol_w_id numeric , ol_d_id numeric , ol_o_id numeric , ol_number numeric , ol_i_id numeric, ol_delivery_d timestamp without time zone, ol_amount numeric, ol_supply_w_id numeric, ol_quantity numeric, ol_dist_info character(24)) WITH (fillfactor='50');         
CREATE TABLE public.item (i_id numeric(6,0) , i_im_id numeric, i_name character varying(24), i_price numeric(5,2), i_data character varying(50)) WITH (fillfactor='50');        
...
SELECT create_distributed_function('DBMS_RANDOM (INTEGER, INTEGER) ');
