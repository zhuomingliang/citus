...
static const struct config_enum_entry coordinator_aggregation_options[] = {
	...
	{ "array-fold", COORDINATOR_AGGREGATION_ARRAY_FOLD, false },
...
RegisterCitusConfigVariables(void)
{
	...
	DefineCustomEnumVariable(
		...
		gettext_noop("Array folding is preferable for small intermediate results with "
					 "grouping or which occur alongside aggregates which can be pushed down."),
